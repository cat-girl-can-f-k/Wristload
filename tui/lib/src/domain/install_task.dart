...
class InstallTask {
  ...
  /// Whether a matching device business completion event was validated.
  ///
  /// Transfer completion and Mass ACKs never set this flag. It is only true
  /// after the install-specific completion event has been parsed and matched
  /// to this request.
