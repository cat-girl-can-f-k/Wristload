...
The executable is `build/wearable_macos_bridge` and links `Foundation.framework` and `IOBluetooth.framework`. Xcode command-line tools are required. It is classic Bluetooth / RFCOMM, not BLE GATT.
